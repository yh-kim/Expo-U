...
public class ContentDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_content_detail, container, false);

        try {
            arr_list = new ServiceDAOImpl().getContent();
            Log.e("opop",position+"입니다");
        ...
        Drawable test1 = getResources().getDrawable(R.drawable.test1);
        Drawable test2 = getResources().getDrawable(R.drawable.test2);
        Drawable test1_1 = getResources().getDrawable(R.drawable.test1_1);
        Drawable test1_2 = getResources().getDrawable(R.drawable.test1_2);
        Drawable test1_3 = getResources().getDrawable(R.drawable.test1_3);
        ...
        txt1.setText(arr_list.get(position).getDate());
        txt2 = (TextView) rootView.findViewById(R.id.content1);
        txt2.setText(arr_list.get(position).getDetail());
